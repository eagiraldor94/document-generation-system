  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark"> Contrato de trabajo a término fijo <small>inferior a un año</small></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
            ...
            <div class="row">  
              <div class="form-group ml-3" style="width: 96.5%">
                <div class="input-group mb-3">
                  ...
                  <input class="form-control" type="text" name="newFirstPart" placeholder="Nombre Empleador" required>
                </div>
              </div>
            </div>
            <!-- Documento -->
