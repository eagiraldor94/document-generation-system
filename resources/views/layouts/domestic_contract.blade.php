        ...
        <div class="card-body">
            ...
            <!-- Ciudad -->
               <div class="form-group ml-3" style="width:47.5%">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="newSecondNeighborhood" placeholder="Barrio donde laborará" required>
                  </div>
               </div>
            <!-- Ciudad -->
               <div class="form-group ml-3" style="width:47.5%">
            ...
            <!-- Email -->
              <div class="form-group ml-3" style="width:96.5%">
                ...
                <input class="form-control" type="email" name="newFirstEmail" placeholder="Email de envío">
              </div>
               </div>
            </div>        
        </div>
