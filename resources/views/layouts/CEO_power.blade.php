  ...
  <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark"> Poder amplio y suficiente <small> otorgado por representante legal</small></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
...
<!-- Default box --> 
      <div class="card mb-5 text-center">
        <form role="form" method="post" action="/pceo" enctype="multipart/form-data">
          @csrf
            ...
            <div class="row">  
              <div class="form-group col-12">
                <div class="input-group mb-3">
                  ...
                  <input class="form-control" type="text" name="newCompany" placeholder="Nombre de la Empresa" required>
                </div>
              </div>
            </div>
            <!-- Documento -->
            <div class="row">
              <div class="form-group col-12 col-sm-4">
                <div class="input-group mb-3">
                    ...
                    <select name="newCompanyIdType" class="form-control" required>
                      <option value="">Tipo de documento</option>
                      <option value="NIT">NIT</option>
                    </select>
                  </div>
               ...
               <div class="form-group col-12 col-sm-8">
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" name="newCompanyId" placeholder="Número del documento" required>
                  </div>
               </div>
             </div>
             <div class="row">
            <!-- Residencia -->
               <div class="form-group col-12">
                <div class="input-group mb-3">
                    ...
                    <input title="Ciudad o municipio donde esta domiciliada la compañia" type="text" class="form-control" name="newCompanyCity" placeholder="Ciudad de domicilio" required>
                  </div>
               </div>
             </div>
            <div class="row">
            ...
            <div class="row">  
              <div class="form-group col-12">
                <div class="input-group mb-3">
                  ...
                  <small class="form-text text-left">Ej: El fiscal, El notario, El juez, Juan Pérez, A quíen pueda interesar. Si es un juez se debe especificar tipo de juez y reparto, por ejemplo: Juez civil del circuito 13 </small>
              </div>
            </div>
            <div class="row">
            <!-- Tipo de formulación -->
