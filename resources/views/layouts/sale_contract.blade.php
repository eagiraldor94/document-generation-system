            ...
            <!-- Expedicion -->
               <div class="form-group col-12 col-sm-6">
                <div class="input-group mb-3">
                    ...
                    <input title="Ciudad donde se expidió el documento del vendedor" type="text" class="form-control" name="newSellerExpedition" placeholder="Ciudad de expedición (Opcional)">
                  </div>
               </div>
             </div>
            <div class="row">
            ...
            <!-- Expedicion -->
               <div class="form-group col-12 col-sm-6">
                <div class="input-group mb-3">
                    ...
                    <input title="Ciudad donde se expidió el documento del vendedor" type="text" class="form-control" name="newBuyerExpedition" placeholder="Ciudad de expedición (Opcional)">
                  </div>
               </div>
             </div>
            <div class="row">
              ...
              <div class="form-group col-12 col-sm-6">
                <div class="input-group mb-3">
                  ...
                  <div class="input-group-append">
                      <select name="newCapacityType" class="input-group-text" required>
                        <option value="">¿kg o Psj?</option>
                        <option value="kg">Kilogramos</option>
                        <option value="Psj">Pasajeros</option>
                      </select>
                  </div>
                </div>
              </div>
